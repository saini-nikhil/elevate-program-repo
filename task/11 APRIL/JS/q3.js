data = [
  ...
  let sortmovie = data.sort((a,b) => {
    if (b.rating !== a.rating) {
        return b.rating - a.rating; // Descending order
    }
    
    // If ratings are the same, sort by movie name in alphabetical order
 
     return a.movieName > b.movieName ? 1 : a.movieName < b.movieName ? -1 : 0;
  })
